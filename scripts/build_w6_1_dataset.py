...
def _development_cases() -> tuple[BusinessEvaluationCase, ...]:
    ...
    resilience = (
        _non_result(
            ...
            fault=FaultExpectation(component="model.plan", occurrences=(1, 2, 3), error_type="ConnectTimeout"),
        ...
        _trusted(
            ...
            fault=FaultExpectation(component="model.summarize", occurrences=(1, 2, 3), error_type="ConnectTimeout"),
